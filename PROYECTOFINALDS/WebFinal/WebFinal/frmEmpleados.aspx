<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="frmEmpleados.aspx.cs" Inherits="WebFinal.Formulario_web13" %>
<asp:Content ID="Content4" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <table align="center" class="auto-style5">
        <tr>
            <td class="auto-style8">Buscar:</td>
            <td>
        ...
        <tr>
            <td class="auto-style8" colspan="2">
                <asp:FileUpload ID="fuCargarArchivo" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Levenim MT" Font-Size="Large" />
            </td>
        </tr>
        <tr>
